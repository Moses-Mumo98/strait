...
function draw_header($pageTitle, $lastmessage = '')
{
	...
	debug("Done With the breadcrumbs");
...
{
	debug("display_smarty_template ".$template_file." Path ".ABSPATH . 'templates/' . $GLOBALS['CONFIG']['theme'] . '/' . $template_file);
...
{
	debug("Redirecting Visitor to ".$url);
    if ($url == '') {
