...
<section class="section">
    <ul class="breadcrumb breadcrumb-style ">
        <li class="breadcrumb-item">
            <h4 id = "page_title" class="page-title m-b-0">Project Tasks</h4>
        </li>
        <li class="breadcrumb-item">
            <a href="home">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <button id = "addTask" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="right"title=""><i data-feather="file-plus"></i><span id = "add_t">Add New Task</span></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <select id = "project_name" name = "project_name" class="form-control select2" onchange="getProjectTasks()"></select>
                            </div>
                        </div>
                        <div class="card-body">
