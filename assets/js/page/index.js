...
function chart2() {
  am4core.ready(function () {
    ...
    createAxisAndSeries("project1", "Project1", false, "circle");
    createAxisAndSeries("project2", "Project2", true, "rectangle");
    ...
    function generateChartData() {
      ...
      for (var i = 0; i < 15; i++) {
        ...
        project1 += Math.round((Math.random() < 0.5 ? 1 : -1) * Math.random() * 10);
        views += Math.round(
          (Math.random() < 0.5 ? 1 : -1) * Math.random() * 10
        );
